...
$pdf->TextWithRotation(30,60,$operacion,90);  
$pdf->TextWithRotation(90,20,$costo,180);
...
$pdf->TextWithRotation(90,40,$asiento,180);
$pdf->TextWithRotation(220,40,$zona,180);
$pdf->TextWithRotation(90,270,$costo,180);
$pdf->TextWithRotation(220,270,$costob,180);
$pdf->TextWithRotation(160,270,$cargo,180);
$pdf->TextWithRotation(160,300,$cuadrante,180);
$pdf->TextWithRotation(140,300,$fila,180);
$pdf->TextWithRotation(90,300,$asiento,180);
$pdf->TextWithRotation(220,300,$zona,180);
$pdf->SetFont('Arial','B',16);
 $pdf->TextWithRotation(160, 200, $artista, 180);
 $pdf->SetFont('Arial','B',14);
 $pdf->TextWithRotation(140,180,$fecha_pres,180);
 $pdf->TextWithRotation(135,160,$hora,180);
 $pdf->SetFont('Arial','B',12);
 $pdf->TextWithRotation(150,140,'Fecha de Impresion',180);
 $pdf->TextWithRotation(140,125, $fecha_imp, 180);
