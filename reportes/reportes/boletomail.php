...
$result=mysql_query("select ventas.costo_b as costob, ventas.comision as comision, ventas.iva_com as iva, ventas.costo as total, ventas.zona as zona, ventas.lugar as lugar,ventas.fila as fila, ventas.cuadrante as seccion, ventas.fecha_op as fecha, ventas.no_operacion as operacion, ventas.no_vta as folio,ventas.cva_lib as cry from ventas where  ventas.cva_lib='$cryboleto' and ventas.download=0",$conexion);
$updatestatus=mysql_query("update ventas set ventas.download=1 where ventas.cva_lib='$cryboleto'",$conexion);
