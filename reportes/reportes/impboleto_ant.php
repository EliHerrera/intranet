...
$pdf->TextWithRotation(200,460,$costo,180);
$pdf->TextWithRotation(400,460,$costob,180);
$pdf->TextWithRotation(300,460,$cargo,180);
$pdf->TextWithRotation(300,480,$cuadrante,180);
$pdf->TextWithRotation(280,480,$fila,180);
$pdf->TextWithRotation(200,480,$asiento,180);
$pdf->TextWithRotation(400,480,$zona,180);
$pdf->TextWithRotation(200,680,$costo,180);
$pdf->TextWithRotation(400,680,$costob,180);
$pdf->TextWithRotation(300,680,$cargo,180);
$pdf->TextWithRotation(300,700,$cuadrante,180);
$pdf->TextWithRotation(280,700,$fila,180);
$pdf->TextWithRotation(200,700,$asiento,180);
$pdf->TextWithRotation(400,700,$zona,180);
