...
<table class="table">
    ...
    WHERE
        ...
        while ($row=$queryResult->fetch(PDO::FETCH_ASSOC)) {
            ...
            echo "<tr class='".$class_alert."'><td>".$num."</td><td><a href='gestionarproyecto.php?idpj=".$idpj."'>".$proyecto."</a></td><td>".$owner."</td><td>".$areaimpacto."</td><td>".$porcentaje."</td><td>".$status."</td><td>".$ffinal."</td><td>".$interval2->format('%R%a días')."</td></tr>";
