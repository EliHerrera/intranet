...
GROUP BY
 ...
 while ($row=$queryResult->fetch(PDO::FETCH_ASSOC)) {    
    $queryInsert=$pdo->prepare("INSERT INTO Intranet.carterabi (IDEjecutivo,Saldo,Producto,fecha,Empresa,tipo) VALUES($row[IDEjecutivo],$row[Saldo],'CR','$hoy',2,1)");
    $queryInsert->execute();
 }
 $queryResult=$pdo->query("SELECT
 CONCAT(
...
GROUP BY
 C.ID");
 while ($row=$queryResult->fetch(PDO::FETCH_ASSOC)) {    
    $queryInsert=$pdo->prepare("INSERT INTO Intranet.carterabi (IDEjecutivo,Saldo,Producto,fecha,Empresa,tipo) VALUES($row[IDEjecutivo],$row[Saldo],'AP','$hoy',2,1)");
    $queryInsert->execute();
 }
 $queryResult=$pdo->query("SELECT
 CONCAT(
...
GROUP BY
 C.ID");
 while ($row=$queryResult->fetch(PDO::FETCH_ASSOC)) {    
    $queryInsert=$pdo->prepare("INSERT INTO Intranet.carterabi (IDEjecutivo,Saldo,Producto,fecha,Empresa,tipo) VALUES($row[IDEjecutivo],$row[Saldo],'AP','$hoy',3,1)");
    $queryInsert->execute();
 }
 $queryResult=$pdo->query("SELECT
 CONCAT(
...
GROUP BY
 C.ID");
 while ($row=$queryResult->fetch(PDO::FETCH_ASSOC)) {    
    $queryInsert=$pdo->prepare("INSERT INTO Intranet.carterabi (IDEjecutivo,Saldo,Producto,fecha,Empresa,tipo) VALUES($row[IDEjecutivo],$row[Saldo],'VP','$hoy',3,1)");
    $queryInsert->execute();
 }
 ?>
