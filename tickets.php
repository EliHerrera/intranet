...
<div class="row">
  ...
  <div clas="col-xs-2">
    ...
    <h3>Relacion de Incidencias</h3><a href="tickets.php" class="button">Restablecer</a><a href="#" class="button">Agregar Incidencia</a><a href="#" class="button">Administrar</a>
    <table class="table">
    ...
    <?PHP
        ...
        if ($row['Estatus']=='A') {
            ...
            echo "<tr><td><a href='tickets.php?idtic=".$row['ID_Ticket']."'>".$row['folio']."</a></td><td>".$row['Empleado']."</td><td>".$row['fecha_alta']."</td><td>".$row['Titulo']."</td><td>".$status."</td><td><a href='tickets.php?idtic=".$row['ID_Ticket']."'><img src='img/icons/review.png'></a></td></tr>";
        }
